...
import 'package:app_getx/controller/purchase.dart';
                      ...
                      children: [
                        Expanded(
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  controller.barang[index].barangName,
                                  style: TextStyle(
                                      color: Colors.blue,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16.0),
                                ...
                                Text(
                                  controller.barang[index].barangDescription,
                                  style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            onPressed: () =>
                                cart.addToChart(controller.barang[index]),
                            child: Text(
                              'Shop Now',
                              style: TextStyle(
                                  fontWeight: FontWeight.normal,
